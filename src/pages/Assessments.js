              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-4">
                  <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-orange-100 to-orange-200 rounded-xl">
                    ...
                    <span className="text-sm font-semibold text-orange-800">{assessments.length} Total Assessments</span>
                  </div>
                  <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-100 to-blue-200 rounded-xl">
                    <Briefcase className="w-5 h-5 text-blue-600" />
                    <span className="text-sm font-semibold text-blue-800">{jobs.length} Jobs with Assessments</span>
                  </div>
                  <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-green-100 to-green-200 rounded-xl">
                    <Users className="w-5 h-5 text-green-600" />
                    <span className="text-sm font-semibold text-green-800">Active Evaluations</span>
                  </div>
                  <div className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-100 to-purple-200 rounded-xl">
                    <Target className="w-5 h-5 text-purple-600" />
                    <span className="text-sm font-semibold text-purple-800">{assessments.reduce((sum, a) => sum + getQuestionCount(a), 0)} Total Questions</span>
                  </div>
                </div>
              </div>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-3">
                          <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center relative overflow-hidden group-hover:scale-110 group-hover:rotate-12 transition-all duration-500 shadow-lg">
                            <ClipboardList className="w-6 h-6 text-white relative z-10 group-hover:animate-pulse" />
                            <img 
                          ...
                          <div>
                            <CardTitle className="text-xl font-bold text-black group-hover:text-orange-600 transition-colors duration-300">{assessment.title}</CardTitle>
                            <p className="text-black/70 font-semibold">{getJobTitle(assessment.jobId)}</p>
                          </div>
                        </div>
                      </div>
                      <div className="relative">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-4 text-sm text-black/70">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium">{getQuestionCount(assessment)} questions</span>
                        </div>
                        <div className="flex items-center gap-2">
                      ...
                      <div className="pt-2">
                        <p className="text-sm font-bold text-black mb-2">Sample Questions:</p>
                        <div className="space-y-2">
                          {assessment.questions.slice(0, 2).map((question, questionIndex) => (
                            <div key={questionIndex} className="text-sm text-black/70 bg-gradient-to-r from-orange-50 to-orange-100 p-3 rounded-xl border border-orange-200">
          ...
          <div className="group relative">
            ...
            <Card className="relative group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-0 shadow-lg bg-white/90 backdrop-blur-sm">
              <CardContent className="p-16 text-center relative z-10">
                ...
                <h3 className="text-2xl font-bold text-black mb-4">No assessments found</h3>
